...
const services = [
  {
    title: "Хатха-йога",
    description: "Классическая практика для гармонии тела и дыхания. Подходит для начинающих и опытных практиков любого возраста.",
    iconName: "Flower2",
  },
  {
    title: "Пилатес",
    description: "Работа с глубокими мышцами корпуса. Улучшает осанку, снимает боли в спине, формирует красивый силуэт.",
    iconName: "Dumbbell",
  },
  {
    title: "Йога для начинающих",
    description: "Мягкое введение в практику: базовые асаны, дыхание и основы медитации. Без опыта и специальной подготовки.",
    iconName: "Sprout",
  },
  {
    title: "Индивидуальные занятия",
    description: "Персональная программа с учётом вашего тела, целей и ритма жизни. Максимальный результат в минимальный срок.",
    iconName: "User",
  },
]
