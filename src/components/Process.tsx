...
const steps = [
  {
    ...
    title: "Приходишь",
    description:
      "Просто приходишь — без опыта, без ожиданий, без спортивной формы на «пятёрку». Мы начинаем с тебя таким, какой ты есть прямо сейчас.",
  },
  {
    number: "02",
    title: "Дышишь",
    description:
      "Учишься дышать осознанно. Дыхание — это первый инструмент управления собой. Через него тело расслабляется, а голова проясняется.",
  },
  {
    number: "03",
    title: "Практикуешь",
    description:
      "Занятия становятся привычкой. Тело укрепляется, осанка выравнивается, уровень стресса снижается. Изменения заметны уже через месяц.",
  },
  {
    number: "04",
    title: "Властвуешь",
    description:
      "Ты чувствуешь себя хозяином своего тела и состояния. Это не пункт назначения — это новый способ жить каждый день.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Не нужно быть гибким или спортивным. Нужно только желание — всё остальное придёт на коврике.
              </p>
            </div>
          </div>
