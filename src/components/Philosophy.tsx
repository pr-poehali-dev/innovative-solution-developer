      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:pl-8">
            ...
            >
              Тело и разум —
              <span className="italic"> одно</span>
              <br />
              целое
            </h2>
            ...
            >
              <p>
                Мы верим, что истинная сила рождается изнутри. Йога учит нас слышать своё тело,
                пилатес — выстраивать его опору. Вместе они дают то, чего не хватает в суете: центр.
              </p>
              <p>
                Наш подход вдохновлён японской концепцией <em className="text-foreground">ма</em> — умением находить
                красоту в паузе — и простой скандинавской мудростью:
                <em className="text-foreground"> меньше напряжения, больше присутствия</em>.
              </p>
            </div>
